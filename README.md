...
<img src="documentations/assets/classic_card.jpg" width="150">
VS 
<img src="documentations/assets/corner_index_card_overlapped.png" width="250">
...
- **Cards**: Player cards, dealer cards, burn cards </br> ![Playing Card](documentations/assets/corner_index_card.png) 

- **Card Holders**: Physical slots where dealer places cards </br> <img src="documentations/assets/card_holder.jpg" width="175">
- **Trap Area**: Discard zone for used cards </br> ![Trap](documentations/assets/trap.jpg) 
- **Special Cards**: 
  - **DealerCard**: Yellow cards indicating dealer change </br> ![Dealer Card](documentations/assets/dealer_card.png) 
  - **SwitchCard**: Red cards signaling shuffle or deck change </br> ![Switch Card](documentations/assets/switch_card.png)
...
![Not Cropped](documentations/assets/not_cropped.jpg)  
![Cropped](documentations/assets/cropped.jpg)
...
![Good Annotation](documentations/assets/good_obb_ls.jpg) 
✅ Rotated to match card angle         
✅ Tight fit around visible corners    
✅ No excessive padding

Bad annotation exemple:
![Bad Annotation](documentations/assets/bad_obb_ls.jpg) 
❌ Axis-aligned (wrong!)                
...
![CLS annotation](documentations/assets/label_studio_cls.jpg) 
...
![OBB Training Batch 0](documentations/assets/train_batch0.jpg)
...
![OBB Labels Distribution](documentations/assets/labels.jpg)
...
![OBB Training Analysis Dashboard](documentations/assets/obb_analysis_dashboard.png)
...
![CLS Training Batch 0](documentations/assets/train_batch1.jpg)
...
![CLS Training Analysis Dashboard](documentations/assets/cls_analysis_dashboard.png)
...
![Zones](documentations/assets/zones.jpg)
...
![GUI](documentations/assets/gui.jpg)
...
![App Screenshot - Hit Soft](documentations/assets/app_1_2_hit_soft_A.jpeg)
...
![App Screenshot - Blackjack](documentations/assets/app_2_2_bj.jpeg)
...
![App Screenshot - Stand Hard](documentations/assets/app_1_2_stand_hard.jpeg)
...
![Layout](documentations/assets/layout.jpg)

#### 4.4.5 Special Event Handling

**Screenshot Example 4: Dealer Switch Event**

![App Screenshot - Dealer Switch](documentations/assets/app_dealer_switch_1.jpeg)
...
![App Screenshot - Holder Switch](documentations/assets/app_switch_card_holder.jpeg)
...
Copyright © 2026 Florian Barre

All rights reserved.

This project and its source code may not be used, copied, modified, or distributed without explicit written permission from the author.
